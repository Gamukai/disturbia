...
{
    GreenPickup* pickup = [[GreenPickup alloc] initWithParent: parentNode];
...
{
    self = [super initWithImageNamed:@"green_test_tube"];
    if (self) {
...
- (void) handleBeginContactWithOtherNode: (SKNode *) otherNode
{
    if (otherNode)
    {
        ...
        if (_delegate) [_delegate greenPickupDidCollected];
    }
}
